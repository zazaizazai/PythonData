...
def clean_and_convert(value, type):
    ...
    value = value.replace('â€¯', '').replace('HKD', '').replace('âˆ’', '-').replace('%', '').strip()
...
with open('ausgewaehlte_spaltenhs.csv', 'r') as csv_file:
...
file_paths = [
    "C:/Users/fawad/AppData/Roaming/MetaQuotes/Terminal/81A933A9AFC5DE3C23B15CAB19C63850/MQL5/Files/TVhsk.txt",
    "C:/Users/fawad/AppData/Roaming/MetaQuotes/Terminal/FB52B33C7584E2EEADD1C5E58004AD52/MQL5/Files/TVhsk.txt",
    "C:/Users/farha/AppData/Roaming/MetaQuotes/Terminal/C4CE7E5647DA1EB91E3C2593C03B1A28/MQL4/Files/TVhsk.txt",
