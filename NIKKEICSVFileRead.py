...
def clean_and_convert(value, type):
    ...
    value = value.replace('â€¯', '').replace('JPY', '').replace('âˆ’', '-').replace('%', '').strip()
...
with open('ausgewaehlte_spaltenni.csv', 'r') as csv_file:
...
file_paths = [
    "C:/Users/Fawad/AppData/Roaming/MetaQuotes/Terminal/FB52B33C7584E2EEADD1C5E58004AD52/MQL5/Files/TVnik.txt",
    "C:/Users/fawad/AppData/Roaming/MetaQuotes/Terminal/D0E8209F77C8CF37AD8BF550E51FF075/MQL5/Files/TVnik.txt",
    "C:/Users/farha/AppData/Roaming/MetaQuotes/Terminal/C4CE7E5647DA1EB91E3C2593C03B1A28/MQL4/Files/TVnik.txt",
