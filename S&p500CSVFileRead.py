...
with open('ausgewaehlte_spaltensp.csv', 'r') as csv_file:
    csv_reader = csv.DictReader(csv_file)
        
    # Ermittle die Anzahl der Zeilen in der CSV-Datei
    lines = list(csv_reader)
    total_lines = len(lines)
    
    for line in lines[:-1]:  # Ausschluss der letzten Zeile
...
file_paths = [
    "C:/Users/Fawad/AppData/Roaming/MetaQuotes/Terminal/FB52B33C7584E2EEADD1C5E58004AD52/MQL5/Files/TVsup.txt",
    "C:/Users/fawad/AppData/Roaming/MetaQuotes/Terminal/D0E8209F77C8CF37AD8BF550E51FF075/MQL5/Files/TVsup.txt",
    "C:/Users/farha/AppData/Roaming/MetaQuotes/Terminal/C4CE7E5647DA1EB91E3C2593C03B1A28/MQL4/Files/TVsup.txt",
